...
class BeautifulReport(ReportTestResult, PATH):
    ...
    def output_report(self):
        ...
        # 修改获取template文件为本地InterfaceModule.Dependency.BeautiifulReport中的文件
        template_path = os.path.abspath(os.path.join(os.getcwd(), "..") + "/Dependency/BeautiifulReport/template/template")
        print(" ")
        print("源码修改：BeautifulReport.py 375行，修改template_path："+template_path)
